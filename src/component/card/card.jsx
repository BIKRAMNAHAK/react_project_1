...
const users = [
    ...
    return (
            ...
            users.map((user) => {
                return (
                    <div>
                        <div className='main-card pb'>
                            <div className='card'>
                                <div className="row">
                                    <div className="col-4 pt-1">
                                        <div className='img-box'>
                                            <img src={user.image} alt="imag" />
                                        </div>
                                    </div>
                                    <div className="col-8 name-dtl">
                                        <div className='m-0'>
                                            ...
                                            <div className="col-12 pt-1">email :
                                                <span>{user.email}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 pt ps">
                                        <div className='full-name'>
                                            Full name:
                                            <span>{user.firstName}</span>
                                            <span className='ps-5'>{user.lastName}</span>
                                            <span className='ps-5'>{user.maidenName}</span>
                                        </div>
                                        <div className='pt-1'>
                                            D.O.B :
...
export default card;
        ...
        //                 <div className="col-8 name-dtl">
        //                     <div className='m-0'>
        //                         <div className="col-12 pt-1">name : </div>
        //                         <div className="col-12 pt-1">email :</div>
        //                     </div>
        //                 </div>
